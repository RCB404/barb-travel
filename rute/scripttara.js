(function () {
  ...
  const configs = {
    romania: {
      ...
      locations: [
        ...
        ["Deta", 45.4116, 21.2225],
        ["Lugoj", 45.6886, 21.9031],
        ["Bocșa", 45.3708, 21.7097],
        ["Reșița", 45.3, 21.8833],
        ["Deva", 45.8667, 22.9],
        ["Alba Iulia", 46.0667, 23.5833],
        ["Sibiu", 45.7983, 24.1256],
        ["Orșova", 44.7214, 22.3936],
        ["Drobeta Turnu Severin", 44.6369, 22.6597],
        ["Târgu Jiu", 45.0456, 23.2745],
  ...
  function initPopup() {
    ...
    $$(".oras-card").forEach((el) =>
      el.addEventListener("click", () => {
        title.textContent = el.dataset.oras || "Oraș";
  ...
  function initMap() {
    ...
    const markerSvg =
      '<svg xmlns="http://www.w3.org/2000/svg" width="25" height="41" viewBox="0 0 25 41"><path fill="#009999" d="M12.5 0C5.9 0 .6 5.3.6 11.9c0 8.3 10.4 18.3 11.4 19.3.3.3.8.3 1.1 0 1-1 11.4-11 11.4-19.3C24.4 5.3 19.1 0 12.5 0z"/><circle cx="12.5" cy="12.5" r="5.2" fill="#fff"/></svg>';
    const icon = L.icon({
      iconUrl:
    ...
    cfg.locations.forEach(([name, lat, lon]) =>
      L.marker([lat, lon], { icon })
        .bindPopup(
          '<div class="popup-actions"><strong>' +
            name +
            '</strong><a href="tel:+40741668911" class="btn call">Sună acum</a><a href="https://wa.me/40741668911" target="_blank" rel="noopener" class="btn reserve">WhatsApp</a></div>',
        )
        .addTo(layer),
    );
